# Contributing to dtlg

This outlines how to propose a change to dtlg.
...
* Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("AscentSoftware/dtlg", fork = TRUE)`.
...
Please note that the dtlg project is released with a
