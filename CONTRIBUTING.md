...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("AscentSoftware/dtlg", fork = TRUE)`.
...
Please note that the dtlg project is released with a [Contributor Code
of Conduct](https://AscentSoftware.github.io/dtlg/CODE_OF_CONDUCT.md).
